...
class CustomViewer {
    ...
    private val frameCallback = object : Choreographer.FrameCallback {
        ...
        override fun doFrame(currentTime: Long) {
            ...
            modelViewer.animator?.apply {
                if (animationCount > 0) {
                    applyAnimation(10, seconds.toFloat())
                }
                updateBoneMatrices()
            }
    ...
    fun crossFadeAnimations(previousAnimIndex: Int, previousAnimTime: Float, alpha: Float) {
        modelViewer.animator?.applyCrossFade(previousAnimIndex, previousAnimTime, alpha)
    }
